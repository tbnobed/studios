...
CREATE TYPE stream_type AS ENUM ('webrtc', 'hls', 'srt');
...
-- Share a saved multiview layout externally (public token link) and internally
-- (view-only grant to a logged-in user or group).
