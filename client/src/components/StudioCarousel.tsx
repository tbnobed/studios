...
export function StudioCarousel({ studios, onStudioSelect }: StudioCarouselProps) {
  ...
  return (
    <div className="w-full h-full flex flex-col">
      ...
      <div style={{ flex: '3 1 0' }} className="flex items-center justify-center px-2 py-2 relative z-10 min-h-0">
        <GestureHandler
        ...
        >
          ...
          <Card 
            className="overflow-hidden cursor-pointer hover:border-primary/50 border-2 h-full w-auto"
            style={{ aspectRatio: '9/16', maxWidth: '90vw', maxHeight: '100%' }}
