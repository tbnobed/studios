...
export function StudioCarousel({ studios, onStudioSelect }: StudioCarouselProps) {
  ...
  return (
    <div className="w-full h-full flex flex-col">
      ...
      <div className="flex-[4] flex items-center justify-center px-2 py-2 relative z-10 min-h-0">
        <GestureHandler
        ...
        >
          ...
          <Card 
            className="overflow-hidden cursor-pointer hover:border-primary/50 border-2 h-full aspect-[9/16] max-w-full"
